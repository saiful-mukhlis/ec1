...
// 		$cs->registerCssFile(Yii::app()->baseUrl.'/css/bootstrap/css/bootstrap-yii.css');
// 		$cs->registerCssFile(Yii::app()->baseUrl.'/css/font.css');
// 		$cs->registerCssFile(Yii::app()->baseUrl.'/css/style.css');
		
		$cs->registerCssFile(Yii::app()->baseUrl.'/css/style.min.css');
		//$cs->registerCssFile(Yii::app()->baseUrl.'/css/font.css');
		
		$cs->registerCoreScript('jquery');
		$cs->registerScriptFile(Yii::app()->baseUrl . '/js/my.min.js', CClientScript::POS_END);
